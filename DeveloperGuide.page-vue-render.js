...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 family members without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("All features should function without requiring an internet connection.")]),_v(" "),_c('li',[_v("The application should launch and be ready for user interaction within 5 seconds on standard hardware.")]),_v(" "),_c('li',[_v("The application should handle unexpected inputs gracefully with informative error messages.")]),_v(" "),_c('li',[_v("All commands should execute and display results within 2 seconds on a standard computer system.")]),_v(" "),_c('li',[_v("All family data should be stored locally.")])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs"}},[_c('span',[_v("### Glossary\n")]),_c('span',[_v("\n")]),_c('span',[_v("* **Mainstream OS**: Windows, Linux, Unix, MacOS\n")]),_c('span',[_v("* **Private contact detail**: A contact detail that is not meant to be shared with others\n")]),_c('span',[_v("\n")]),_c('span',[_v("--------------------------------------------------------------------------------------------------------------------\n")]),_c('span',[_v("\n")]),_c('span',[_v("## **Appendix: Instructions for manual testing**\n")]),_c('span',[_v("\n")]),_c('span',[_v("Given below are instructions to test the app manually.\n")]),_c('span',[_v("\n")]),_c('span',[_v("<box type=\"info\" seamless>\n")]),_c('span',[_v("\n")]),_c('span',[_v("**Note:** These instructions only provide a starting point for testers to work on;\n")]),_c('span',[_v("testers are expected to do more *exploratory* testing.\n")]),_c('span',[_v("\n")]),_c('span',[_v("</box>\n")]),_c('span',[_v("\n")]),_c('span',[_v("### Launch and shutdown\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. Initial launch\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Download the jar file and copy into an empty folder\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Double-click the jar file Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. Saving window preferences\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Resize the window to an optimum size. Move the window to a different location. Close the window.\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Re-launch the app by double-clicking the jar file.<br>\n")]),_c('span',[_v("       Expected: The most recent window size and location is retained.\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. _{ more test cases …​ }_\n")]),_c('span',[_v("\n")]),_c('span',[_v("### Deleting a person\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. Deleting a person while all persons are being shown\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Prerequisites: List all persons using the `list` command. Multiple persons in the list.\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Test case: `delete 1`<br>\n")]),_c('span',[_v("       Expected: First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Test case: `delete 0`<br>\n")]),_c('span',[_v("       Expected: No person is deleted. Error details shown in the status message. Status bar remains the same.\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. Other incorrect delete commands to try: `delete`, `delete x`, `...` (where x is larger than the list size)<br>\n")]),_c('span',[_v("       Expected: Similar to previous.\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. _{ more test cases …​ }_\n")]),_c('span',[_v("\n")]),_c('span',[_v("### Saving data\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. Dealing with missing/corrupted data files\n")]),_c('span',[_v("\n")]),_c('span',[_v("    1. _{explain how to simulate a missing/corrupted file, and the expected behavior}_\n")]),_c('span',[_v("\n")]),_c('span',[_v("1. _{ more test cases …​ }_\n")])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Mon, 17 Mar 2025, 23:30:23 GMT+8]")])])])}
}];
